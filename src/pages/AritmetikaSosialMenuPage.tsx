...
const subTopics = [
  ...
  { label: "Diskon dan Pajak", path: "/materi/aritmetika-sosial/pengurangan" },
  { label: "Bunga Tabungan", path: "/materi/aritmetika-sosial/perkalian" },
  { label: "Bruto, Neto, dan Tara", path: "/materi/aritmetika-sosial/pembagian" },
  { label: "Soal Campuran", path: "/materi/aritmetika-sosial/campuran" },
  { label: "Koperasi dan Keuangan", path: "/materi/aritmetika-sosial/kpk-fpb" },
];
